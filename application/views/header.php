                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <ul class="contact-details">
                                <li><a href="#"><i class="fa fa-map-marker"></i> Cd. Obregon, México</a>
                                </li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i> milton_marti@hotmail.com</a>
                                </li>
                                <li><a href="#"><i class="fa fa-phone"></i> (644) 416-50-42</a>
                                </li>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php">
                            <img alt="" src="images/logo.png" height="47px" width="60px">
                        </a>
                    </div>
